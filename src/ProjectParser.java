...
import Node.ClassNodeMap;
import Node.MethodNodeMap;
import Node.ProjectNodeMap;
import Node.RelMap;
...
public class ProjectParser extends AbstractParser {
	 ...
	 */
	public ProjectParser(String projName, String fileLocation,
			String[] sourcepathEntries, String[] classpathEntries,
			String[] sourcepaths) {
	 ...
	 */
	public ProjectParser(String projName, String fileLocation,
			String[] sourcepathEntries, Collection<String> classpathEntries,
	...
	public void parse() {
		...
		pars.setEnvironment(/* classpathEntries */classpathEntries, /* sourcepathEntries */
				sourcepathEntries,
				/* encodings */null, true);
		// enable binding
